...
/*
Rename variables to start with 'global_' , in all files used:
example: 'int Top_ID' will be 'int global_top_id'. This is to
prevent possible confusion when designing GUI, and later modules.
*/
